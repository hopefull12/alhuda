        ...
        <section id="slider" class="slider-parallax swiper_wrapper clearfix">
            ...
            <div class="swiper-container swiper-parent">
                <div class="swiper-wrapper">
                    <div class="swiper-slide dark" style="background-image: url('images/alhuda/al-new-model2.png');">
                        <div class="container clearfix">
                    ...
                    <div class="swiper-slide dark" style="background-image: url('images/alhuda/al-new-model3.png');">
                        <div class="container clearfix">
                            <div class="slider-caption slider-caption-center">
                    ...
                    <div class="swiper-slide dark" style="background-image: url('images/alhuda/al-new-model4.png');">
                        <div class="container clearfix">
                            <div class="slider-caption slider-caption-center">
                                <h2 data-caption-animate="fadeInUp"></h2>
                                <p data-caption-animate="fadeInUp" data-caption-delay="200"></p> 
                    ...
                    <div class="swiper-slide dark" style="background-image: url('images/alhuda/al-new-model5.png');">
                        <div class="container clearfix">
                            <div class="slider-caption slider-caption-center">
                                <h2 data-caption-animate="fadeInUp"></h2>
                                <p data-caption-animate="fadeInUp" data-caption-delay="200"></p> 
