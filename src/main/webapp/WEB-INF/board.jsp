        ...
        <section id="page-title">
            ...
            <div class="container clearfix">
                ...
                <ol class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active"><a href="#">Board of Trustees</a></li>                    
                </ol>
            </div>
            ...
            <div class="content-wrap">
                ...
                <div class="container clearfix">
                    ...
                    <div class="col_one_third">
                        ...
                        <div class="team">
                            <div class="team-desc">
                                <div class="team-title"><h4>Aqeel Akhtar</h4><span>Treasurer</span></div>
                                <a href="#" class="social-icon inline-block si-small si-light si-rounded si-facebook">
                                    <i class="icon-facebook"></i>
                                    <i class="icon-facebook"></i>
                                </a>
                    ...
                    <div class="col_one_third">
                        ...
                        <div class="team">
                            <div class="team-desc">
                                <div class="team-title"><h4>Salman Faiz</h4><span></span></div>
                                <a href="#" class="social-icon inline-block si-small si-light si-rounded si-facebook">
                                    <i class="icon-facebook"></i>
                                    <i class="icon-facebook"></i>
                                </a>
                    ...
                    <div class="col_one_third">
                        ...
                        <div class="team">
                            <div class="team-desc">
                                <div class="team-title"><h4>Abdul Azeez Mohammed</h4><span></span></div>
                                <a href="#" class="social-icon inline-block si-small si-light si-rounded si-facebook">
                                    <i class="icon-facebook"></i>
                                    <i class="icon-facebook"></i>
                                </a>
