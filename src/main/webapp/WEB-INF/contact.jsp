                    ...
                    <div class="postcontent nobottommargin">
                        ...
                        <form class="nobottommargin" id="template-contactform" name="template-contactform" action="contactus" method="post">
                            ...
                            <div class="col_one_third">
                                ...
                                <input type="text" id="senderName" name="senderName" value="" class="sm-form-control required" />
                            </div>

                            <div class="col_one_third">
                                <label for="template-contactform-email">Email <small>*</small></label>
                                <input type="email" id="fromEmail" name="senderEmail" value="" class="required email sm-form-control" />
                            </div>

                            <div class="col_one_third col_last">
                                <label for="template-contactform-phone">Phone</label>
                                <input type="text" id="senderPhone" name="senderPhone" value="" class="sm-form-control" />
                            </div>
                            ...
                            <div class="col_two_third">
                                ...
                                <input type="text" id="emailSubject" name="emailSubject" value="" class="required sm-form-control" />
                            </div>
                            ...
                            <div class="col_full">
                                ...
                                <textarea class="required sm-form-control" id="emailBody" name="emailBody" rows="6" cols="30"></textarea>
                            </div>
